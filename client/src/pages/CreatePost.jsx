      ...
      <div className='max-w-6xl mx-auto p-6'>
        ...
        space-y-4'>
          ...
          <div className='flex items-center gap-3'>
            <img src={user.profile_picture || assets.sample_profile} alt="" className='w-12 h-12
            rounded-full shadow' />
            <div>
          ...
          {/* Text Area */}
          <textarea name='content' id='content' className='w-full resize-none max-h-20 mt-4 text-sm
              ...
              {images.map((file, i) => (
                <div key={i} className='relative group'>
                  {file.type.startsWith('video/') ? (
                    <video src={URL.createObjectURL(file)} className='h-20
                  rounded-md object-cover' />
                  ) : (
                    <img src={URL.createObjectURL(file)} className='h-20
                  rounded-md' alt="" />
                  )}
