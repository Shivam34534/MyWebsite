...
const DiscoverPage = () => {
  ...
  return (
    <div className="bg-surface min-h-screen">
      <TopNavBar />
      <SideNavBar />
      <main className="flex-1 lg:ml-64 px-6 md:px-12 py-8 bg-surface">
        <section className="max-w-5xl mx-auto mb-16 pt-8">
          <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight mb-6 font-headline">
          ...
          <div className="relative group max-w-3xl">
            ...
            <input className="w-full pl-16 pr-8 py-6 rounded-2xl border-none bg-surface-container-low focus:ring-4 ring-primary/20 text-xl font-medium transition-all shadow-sm" placeholder="Who are you looking for?" type="text"/>
