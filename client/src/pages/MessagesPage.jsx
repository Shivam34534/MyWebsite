    ...
    <div className="bg-surface min-h-screen flex">
      ...
      <main className="flex-grow lg:ml-64 flex flex-col h-screen overflow-hidden">
        ...
        <div className="mt-16 flex flex-grow overflow-hidden">
          ...
          <aside className="w-full md:w-1/3 bg-surface-container-low flex flex-col border-r-0">
          ...
          <section className="hidden md:flex flex-col w-2/3 bg-surface relative">
            <header className="p-6 bg-white/40 backdrop-blur-md flex justify-between items-center z-10">
            ...
            <footer className="p-6 bg-surface">
